...
impl CudaEngine {
    ...
    pub fn get_nb_io_tensors(&self) -> Result<i32> {
        #[cfg(feature = "mock")]
        {
            ...
            let result = unsafe { trtx_sys::trtx_cuda_engine_get_nb_io_tensors(self.inner, &mut count) };
        ...
        #[cfg(not(feature = "mock"))]
        {
            ...
            let count = unsafe {
                trtx_sys::engine_get_nb_io_tensors(self.inner)
            };
    ...
    pub fn get_tensor_name(&self, index: i32) -> Result<String> {
        ...
        #[cfg(not(feature = "mock"))]
        {
            ...
            let name_ptr = unsafe {
                trtx_sys::engine_get_tensor_name(self.inner, index)
            };
    ...
    pub fn create_execution_context(&self) -> Result<ExecutionContext<'_>> {
        ...
        #[cfg(not(feature = "mock"))]
        {
            ...
            let context_ptr = unsafe {
                trtx_sys::engine_create_execution_context(self.inner)
            };

            if context_ptr.is_null() {
                return Err(Error::Runtime("Failed to create execution context".to_string()));
            }
...
impl<'a> ExecutionContext<'a> {
    ...
    pub unsafe fn set_tensor_address(
        ...
        #[cfg(not(feature = "mock"))]
        {
            ...
            let success = unsafe {
                trtx_sys::context_set_tensor_address(
                    self.inner,
                    name_cstr.as_ptr(),
                    data
                )
    ...
    pub unsafe fn enqueue_v3(&mut self, cuda_stream: *mut std::ffi::c_void) -> Result<()> {
        ...
        #[cfg(not(feature = "mock"))]
        {
            ...
            let success = unsafe {
                trtx_sys::context_enqueue_v3(self.inner, cuda_stream)
            };
